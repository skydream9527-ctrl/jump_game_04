...
export function MainMenu({ totalShards, testMode, onStartGame, onCharacterSelect, onShop, onLeaderboard, onInventory, onPet, onAchievements, onToggleTestMode }: MainMenuProps) {
  return (
